...
import {RiSearchLine,RiShoppingBag3Line,RiCloseCircleLine, RiArrowDropDownLine} from 'react-icons/ri';

const Header = () => {
  return (
    <header className="fixed w-full top-0 left-0 z-50 py-4 min-h-[68px] 
        ...
        <nav className="mx-auto flex flex-row justify-between items-center">
					...
					<ul className="hidden md:flex gap-8">
						...
						<li className="relative group" id="products-menu">
							<a href="#"
							  ...
							  Products
							  {/* <i id="dropdown-icon" className="ri-arrow-drop-down-line text-lg transform transition-transform duration-300 group-hover:rotate-180"></i> */}
			...
			{/* Menu cho Mobile */}
			<div className="menu__mobile md:hidden absolute top-[68px] 
						right-0 bg-[#fff] w-2/3 transition translate-x-full uppercase h-screen" id="mobile-menu">
				<ul className="flex flex-col md:flex-row gap-8 shadow-[rgba(0,0,0,0.1)_-4px_0px_10px] py-4 pl-8">
					...
					<li>
						<div className="flex items-center cursor-pointer gap-8" id="mobile-products-toggle">
							<a href="#">Products</a>
							{/* <i className="ri-arrow-drop-down-line text-xl transition-transform duration-300" id="mobile-arrow-product"></i> */}
							<RiArrowDropDownLine id="mobile-arrow-product" className="text-xl transition-transform duration-300" />
						</div>
						{/*  Submenu  */}
						<ul className="hidden flex-col pl-4 mt-2 space-y-2" id="mobile-submenu">
